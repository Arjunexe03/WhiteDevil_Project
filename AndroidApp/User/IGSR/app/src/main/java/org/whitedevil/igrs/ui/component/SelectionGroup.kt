...
import org.whitedevil.igrs.ui.common.LocalFixedColorRoles
...
object SelectionGroupDefaults {
    ...
    fun shape(selected: Boolean): Shape {
        val animatedRoundedCorner by animateDpAsState(
    ...
    fun colors(
        ...
        return defaultSelectionGroupItemColors.run {
            copy(
                ...
                disabledActiveContainerColor = disabledActiveContainerColor.takeOrElse { this.disabledActiveContainerColor },
                disabledActiveContentColor = disabledActiveContentColor.takeOrElse { this.disabledActiveContentColor },
                disabledInactiveContainerColor = disabledInactiveContainerColor.takeOrElse {
                    this.disabledInactiveContainerColor
                },
                disabledInactiveContentColor = disabledInactiveContentColor.takeOrElse { this.disabledInactiveContentColor },
            )
        }
    }
